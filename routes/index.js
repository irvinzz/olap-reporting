...
exports.palo = function(req,res){
    
};

exports.api = function(req,res){
	palo.getClient(req.session,function(err,client){
        var e = req.params.entry;
        var r = req.params.request;
        
        client.call(e,r,req,function(err,result){
            if (!err){
                ...
                res.json(500,[result,errorHandler[result[0]]]);
            }
        });
    });
	
    /*var palov = new paloClass({
